...
class Author:
    ...
    def contracts(self):
        return [
            contract for contract in Contract.all if contract.author.name == self.name
        ]
    ...
    def books(self):
        return [
            ...
            if contract.author.name == self.name
        ]
...
class Book:
    ...
    def contracts(self):
        return [
            contract for contract in Contract.all if contract.book.title == self.title
        ]
    ...
    def authors(self):
        return [
            contract.author
            for contract in Contract.all
            if contract.book.title == self.title
        ]
